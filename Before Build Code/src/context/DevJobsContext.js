    ...
    function () {
      (async function () {
        if (search) {
          try {
            const resData = await fetch(
              `https://api.adzuna.com/v1/api/jobs/${countryCode}/search/1?app_id=8ba2f550&app_key=757a734682e6b0b6a7007c8aae173f47&results_per_page=100&what=${jobType}&content-type=application/json`
            );
